...
router.get('/', function(req, res, next) {
  var osubbresp = {
        ...
        games: [
              ...
              {date:"1/5", Time:"7 pm ", TV:"espn", Opp:"Purdue",  OppImage: "pur-sm.png", Loc: "Home", OppNH:"Boilermakers", OppShort: "PUR", BTG:1, OppScore:76, OSUScore:75, OppRank:20, OSURank:0},
              {date:"1/8", Time:"7:30 pm ", TV:"btn", Opp:"Minnesota",  OppImage: "minn-sm.png", Loc: "Away", OppNH:"Gophers", OppShort: "MINN", BTG:1, OppScore:78, OSUScore:68, OppRank:0, OSURank:0},
              {date:"1/12", Time:"7 pm ", TV:"espn", Opp:"Wisconsin",  OppImage: "wis-sm.png", Loc: "Away", OppNH:"Badgers", OppShort: "WISC", BTG:1, OppScore:89, OSUScore:66, OppRank:0, OSURank:0},
              {date:"1/15", Time:"1:30 pm  ", TV:"cbs", Opp:"Mich State",  OppImage: "msu-sm.png", Loc: "Home", OppNH:"Spartans", OppShort: "MSU", BTG:1, OppScore:67, OSUScore:72, OppRank:0, OSURank:0},
              {date:"1/18", Time:"9 pm ", TV:"btn", Opp:"Nebraska",  OppImage: "neb-sm.png", Loc: "Away", OppNH:"Corn Huskers", OppShort: "NEB", BTG:1, OppScore:66, OSUScore:67, OppRank:0, OSURank:0},
              {date:"1/22", Time:"1 pm ", TV:"btn", Opp:"Northwestern",  OppImage: "nw-sm.png", Loc: "Home", OppNH:"Wildcats", OppShort: "NWN", BTG:1, OppScore:74, OSUScore:72, OppRank:0, OSURank:0},
              {date:"1/25", Time:"7 pm ", TV:"btn", Opp:"Minnesota",  OppImage: "minn-sm.png", Loc: "Home", OppNH:"Gophers", OppShort: "MINN", BTG:1, OppScore:72, OSUScore:78, OppRank:0, OSURank:0},
              {date:"1/28", Time:"8 pm ", TV:"espn", Opp:"Iowa",  OppImage: "iowa-sm.png", Loc: "Away", OppNH:"Hawkeyes", OppShort: "IOWA", BTG:1, OppScore:85, OSUScore:72, OppRank:0, OSURank:0},
              {date:"1/31", Time:"7 pm ", TV:"espn", Opp:"Maryland",  OppImage: "md-sm.png", Loc: "Home", OppNH:"Terapines", OppShort: "MD", BTG:1, OppScore:77, OSUScore:71, OppRank:0, OSURank:0},
              ...
              {date:"2/23", Time:"9 pm ", TV:"espn", Opp:"Wisconsin",  OppImage: "wis-sm.png", Loc: "Home", OppNH:"Badgers", OppShort: "WISC", BTG:1, OppScore:73, OSUScore:83, OppRank:0, OSURank:0},
              {date:"2/28", Time:"8:30 pm ", TV:"btn", Opp:"Penn State",  OppImage: "psu-sm.png", Loc: "Away", OppNH:"Nitney Lions", OppShort: "PSU", BTG:1, OppScore:70, OSUScore:71, OppRank:0, OSURank:0},
