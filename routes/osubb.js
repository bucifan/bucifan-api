...
router.get('/', function(req, res, next) {
  var osubbresp = {
        ...
        games: [
              ...
              {date:"11/21", Time:"7 pm ", TV:"btn", Opp:"Western Carolina",  OppImage: "wcar-sm.png", Loc: "Home", OppNH:"WC", OppShort: "WC", BTG:0, OppScore:66, OSUScore:38, OppRank:0, OSURank:0},
              ...
              {date:"11/25", Time:"7 pm ", TV:"btn", Opp:"Marshall",  OppImage: "mars-sm.png", Loc: "Home", OppNH:"", OppShort: "MSH", BTG:0, OppScore:0, OSUScore:0, OppRank:0, OSURank:0},
              {date:"11/30", Time:"9 pm ", TV:"espn2", Opp:"Virginia",  OppImage: "va-sm.png", Loc: "Away", OppNH:"", OppShort: "VGA", BTG:0, OppScore:0, OSUScore:0, OppRank:0, OSURank:0},
              {date:"12/3", Time:"4:30 pm ", TV:"", Opp:"Fairly Dickinson",  OppImage: "flei-sm.png", Loc: "Home", OppNH:"", OppShort: "FD", BTG:0, OppScore:0, OSUScore:0, OppRank:0, OSURank:0},
              {date:"12/6", Time:"7 pm ", TV:"espn3", Opp:"Florida Atlanic",  OppImage: "fau-sm.png", Loc: "Home", OppNH:"", OppShort: "FA", BTG:0, OppScore:0, OSUScore:0, OppRank:0, OSURank:0},
              {date:"12/10", Time:"6 pm ", TV:"btn", Opp:"UConn",  OppImage: "conn-sm.png", Loc: "Home", OppNH:"", OppShort: "UConn", BTG:0, OppScore:0, OSUScore:0, OppRank:0, OSURank:0},
              {date:"12/20", Time:"7 pm ", TV:"espn3", Opp:"Youngstown State",  OppImage: "youn-sm.png", Loc: "Home", OppNH:"YSU", OppShort: "", BTG:0, OppScore:0, OSUScore:0, OppRank:0, OSURank:0},
              {date:"12/22", Time:"9 pm ", TV:"espn2", Opp:"UNC Asheville",  OppImage: "unca-sm.png", Loc: "Home", OppNH:"", OppShort: "UNCA", BTG:0, OppScore:0, OSUScore:0, OppRank:0, OSURank:0},
              {date:"1/1", Time:"TBA ", TV:"btn", Opp:"Illinios",  OppImage: "ill-sm.png", Loc: "Away", OppNH:"Illini", OppShort: "Ill", BTG:1, OppScore:0, OSUScore:0, OppRank:0, OSURank:0},
              ...
              {date:"2/18-19", Time:"TBA ", TV:"", Opp:"Nebraska",  OppImage: "neb-sm.png", Loc: "Home", OppNH:"Corn Huskers", OppShort: "NEB", BTG:1, OppScore:0, OSUScore:0, OppRank:0, OSURank:0},
              {date:"2/23", Time:"9 pm ", TV:"espn", Opp:"Wisconsin",  OppImage: "wisc-sm.png", Loc: "Home", OppNH:"Badgers", OppShort: "WISC", BTG:1, OppScore:0, OSUScore:0, OppRank:0, OSURank:0},
